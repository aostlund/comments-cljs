...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t13815 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t13815 = (function (val,box,meta13816){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t13815.cljs$lang$type = true;
cljs.core.async.impl.channels.t13815.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t13815";
cljs.core.async.impl.channels.t13815.cljs$lang$ctorPrWriter = (function (this__4111__auto__,writer__4112__auto__,opt__4113__auto__){return cljs.core._write.call(null,writer__4112__auto__,"cljs.core.async.impl.channels/t13815");
});
cljs.core.async.impl.channels.t13815.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t13815.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_13817){var self__ = this;
var _13817__$1 = this;return self__.meta13816;
});
cljs.core.async.impl.channels.t13815.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_13817,meta13816__$1){var self__ = this;
var _13817__$1 = this;return (new cljs.core.async.impl.channels.t13815(self__.val,self__.box,meta13816__$1));
});
cljs.core.async.impl.channels.__GT_t13815 = (function __GT_t13815(val__$1,box__$1,meta13816){return (new cljs.core.async.impl.channels.t13815(val__$1,box__$1,meta13816));
});
}
return (new cljs.core.async.impl.channels.t13815(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_13818 = self__.takes.pop();if((taker_13818 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_13818))
{var take_cb_13819 = cljs.core.async.impl.protocols.commit.call(null,taker_13818);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_13819,taker_13818,this$__$1){
return (function (){return take_cb_13819.call(null,null);
});})(take_cb_13819,taker_13818,this$__$1))
);
} else
{}
{
