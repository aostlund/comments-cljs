...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13809 = (0);while(true){
var m_13810 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13810 == null))
{} else
{m_13810.call(null);
if((count_13809 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13811 = (count_13809 + (1));
count_13809 = G__13811;
continue;
}
} else
{}
