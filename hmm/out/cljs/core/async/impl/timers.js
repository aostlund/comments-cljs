...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_13716 = (0);while(true){
if((i_13716 < arr.length))
{(arr[i_13716] = null);
{
...
{var i_13723 = (self__.level + (1));while(true){
if((i_13723 <= (new_level + (1))))
{(update[i_13723] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_13725 = (0);while(true){
if((i_13725 <= self__.level))
{var links_13726 = (update[i_13725]).forward;if(((links_13726[i_13725]) === x__$1))
{(links_13726[i_13725] = (x__$1.forward[i_13725]));
{
var G__13727 = (i_13725 + (1));
i_13725 = G__13727;
continue;
}
} else
{{
var G__13728 = (i_13725 + (1));
i_13725 = G__13728;
continue;
}
}
