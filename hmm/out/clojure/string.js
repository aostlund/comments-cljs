...
{{
var G__10981 = cljs.core.pop.call(null,v__$1);
v__$1 = G__10981;
continue;
}
} else
...
{var pred__10985 = cljs.core._EQ_;var expr__10986 = limit;if(cljs.core.truth_(pred__10985.call(null,(1),expr__10986)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__10985.call(null,(2),expr__10986)))
...
var G__10988 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10989 = (limit__$1 - (1));
var G__10990 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__10988;
limit__$1 = G__10989;
parts = G__10990;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___10992 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___10992))
{var replacement_10993 = temp__4124__auto___10992;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_10993)));
} else
{buffer.append(ch);
}
{
var G__10994 = (index + (1));
index = G__10994;
continue;
}
}
